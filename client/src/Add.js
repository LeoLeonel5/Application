...
const Add = () => {
    ...
    const cont = collection(db, "UserInformation");
    useEffect(() =>{
      const fetch = async () =>{
        const content = await getDocs(cont);
        setTasks(content.docs.map((doc) =>({...doc.data(), id:doc.id})))
      }
      fetch();
    });
                    ...
                    <tr>
                        ...
                        tasks.map((task, Count) => (
                                <tr>
                                  ...
                                  <td>{task.Mobile}</td>
                                  <td><Link to={{
                                      pathname:`/Edit?Key=${task.id}&Username=${task.Username}&Email=${task.Email}&Mobile=${task.Mobile}`
  ...
  const handleSubmit = (e) =>{
    ...
    return(
      <div className="add-user">
        <h1 style={{"color":"black"}}>USER REGISTRATION</h1><br></br>
        <form onSubmit={handleSubmit}>
          <input className="inp" required="required" onChange={handleData}></input><br></br><br></br>
          <input className="inp" required="required" onChange={handleData}></input><br></br><br></br>
          <input className="inp" required="required" onChange={handleData}></input><br></br><br></br>
          <input className="inp" required="required" onChange={handleData}></input><br></br>
